...
export default function BestSelling() {
  return (
    <div className="Section1 max-h-max w-full font-bold  shadow-lg ">
      ...
      <div className="Grid grid-rows-5  justify-between">
        <div className="flex  mt-5 justify-around ">
          <div>
            ...
            <h1 className="text-lg mx-4 "> Soul </h1>
          ...
          <div>
            ...
            <h1 className="text-lg mx-4 ">Thread </h1>
            <p className="text-sm mx-4">OLIVIA WILSON</p>
          ...
          <div>
            ...
            <h1 className="text-lg mx-4 ">The Young Wizard</h1>
          ...
          <div>
            ...
            <h1 className="text-lg mx-4 ">Walk into the shadow</h1>
          ...
          <div>
            ...
            <h1 className="text-lg mx-4 ">Spear</h1>
